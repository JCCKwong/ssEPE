...
base_L = str(G_CHOICES[get_user_input.base_findings[0]]) + '\n'\
         + 'Positive cores: ' + str(get_user_input.b_p_core) + '/' + str(get_user_input.b_t_core) + '\n'\
         + '% core inv: ' + str(get_user_input.base_p_inv)
mid_L = str(G_CHOICES[get_user_input.mid_findings[0]]) + '\n'\
         + 'Positive cores: ' + str(get_user_input.m_p_core) + '/' + str(get_user_input.m_t_core) + '\n'\
         + '% core inv: ' + str(get_user_input.mid_p_inv)
