...
left_option = col_left.selectbox("Select left lobe feature to compare", features_list, value='PSA')
...
right_option = col_right.selectbox("Select right lobe feature to compare", features_list_r, value='Worst Gleason Grade Group')
