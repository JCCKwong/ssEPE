...
def full_app(session_state):
    ...
    with st.sidebar:
        with st.form(key="my_form"):
            ...
            base_t_core_r = st.number_input('Base # of cores taken', 0, 10, value=2)
            ...
            mid_t_core_r = st.number_input('Mid # of cores taken', 0, 10, value=2)
            ...
            apex_t_core_r = st.number_input('Apex # of cores taken', 0, 10, value=1)
            ...
            tz_t_core_r = st.number_input('Transition zone # of cores taken', 0, 10, value=1)
